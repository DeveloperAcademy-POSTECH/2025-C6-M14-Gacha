...
> **⚠️ 프로젝트 이전 안내**
> 
> 본 프로젝트는 Apple Developer Academy @ POSTECH의 팀 프로젝트로 시작되었으나, </br>
> 2025년 12월부터 개인 프로젝트로 전환되어 개발이 지속되고 있습니다.
>
> 레포지토리 목록</br>
> ~개인 프로젝트로 이어가는 팀원들은 자유롭게 추가해주세요~
> 
> [ohdodin/anggle-ios](https://github.com/ohdodin/anggle-ios)
> 
> 이 레포지토리는 더 이상 업데이트되지 않으며, 모든 개발은 새 레포지토리에서 진행됩니다.
